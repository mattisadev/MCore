package com.mattisadev.mcore.utils.item;

import com.google.common.base.Enums;
import com.google.common.base.Strings;
import com.mattisadev.mcore.compatibility.XMaterial;
import com.mattisadev.mcore.compatibility.XPotion;
import com.mattisadev.mcore.compatibility.SkullUtils;
import com.mattisadev.mcore.utils.ColorUtils;
import com.mattisadev.mcore.utils.NumberUtils;
...
public class MItemBuilder {
    ...
    public static ItemStack loadConfigItem(ConfigurationSection section) {
            ...
            if (meta instanceof CrossbowMeta) {
                ...
                if (section.contains("projectiles")) {
                    for (String projectiles : section.getConfigurationSection("projectiles").getKeys(false)) {
                        ItemStack projectile = loadConfigItem(section.getConfigurationSection("projectiles." + projectiles));
